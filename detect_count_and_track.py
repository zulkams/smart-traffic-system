...
""" area1_pointA = (510,350)
area1_pointB = (1400,350)
area1_pointC = (465,400)
area1_pointD = (1450,400) """


""" area1_pointA = (0,350) #left line upper
area1_pointB = (1400,350) #right line upper
area1_pointC = (0,355)
area1_pointD = (1450,355)
 """
area1_pointA = (0,350) #left line upper
area1_pointB = (1400,350) #right line upper
area1_pointC = (0,400)
...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            cv2.line(im0,area1_pointC,area1_pointD,(255,128,0),2)
            ...
            date = ("%s/%s/%s" % (newdatetime.day, newdatetime.month, newdatetime.year))
            newtime = ("%s:%s:%s" % (newdatetime.hour, newdatetime.minute, newdatetime.second))
            newtype = 0
            ...
            if (count_vehicle == 0):
                ...
                if (counting == old_count):
                    old_count = old_count + 1
                    insert_script = "INSERT INTO entry (uuid, date, time, type) VALUES (%s, %s, %s, %s)"
                    insert_value = ( uid, date, newtime, newtype)
                ...
                if (counting < 100):
                    ...
                    if(len(array_ids)%100 == 0):
                        ...
                        print('modulo counting: '+ str(modulo_counting))
                        array_ids.clear()
            ...
            """ if (counting == old_count): ### 0 == 0
                maxcount = old_count """

            
            """ if (counting > oldcount):
                insert_script = "INSERT INTO entry (uuid, date, time, type) VALUES (%s, %s, %s, %s)"
                insert_value = ( uid, date, newtime, newtype)
                cur.execute(insert_script, insert_value)
                conn.commit()  """
